    ...
    <div class="title-middle w-25">
        ...
        <ul class="list-unstyled">
            ...
            <li>
                ...
                assumenda perspiciatis id quisquam sapiente numquam. Ad officiis cupiditate temporibus
                velit fuga rerum distinctio quod, laboriosam debitis id quia quisquam?
            </li>
        </ul>
    </div>
